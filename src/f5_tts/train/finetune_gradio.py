...
# --- absolute paths for your machine (Windows) ---
path_data = "C:/Users/User/Desktop/F5-TTS/data"
path_project_ckpts = "C:/Users/User/Desktop/F5-TTS/ckpts"
file_train = "C:/Users/User/Desktop/F5-TTS/src/f5_tts/train/finetune_cli.py"

import os
assert os.path.exists(path_data), f"Missing: {path_data}"
assert os.path.exists(path_project_ckpts), f"Missing: {path_project_ckpts}"
assert os.path.isfile(file_train), f"Missing script: {file_train}"
